...
class States:
    ...
    def get_state0(self):
        return np.array([self.ps0, self.pt0, self.T0, self.Tt0, self.u0])     

    def get_state1(self):
        return np.array([self.ps1, self.pt1, self.T1, self.Tt1, self.u1])     

    def get_state2(self):
        return np.array([self.ps2, self.pt2, self.T2, self.Tt2, self.u2])    

    def get_state3(self):
        return np.array([self.ps3, self.pt3, self.T3, self.Tt3, self.u3])     

    def get_state4(self):
        return np.array([self.ps4, self.pt4, self.T4, self.Tt4, self.u4])        

    def get_state5(self):
        return np.array([self.ps5, self.pt5, self.T5, self.Tt5, self.u5])        
    
    def get_state6(self):
        return np.array([self.ps6, self.pt6, self.T6, self.Tt6, self.u6])
    ...
    def __write_states(self):
        ...
        filename = f"dataR/States_RPM{self.Regime}.csv"
